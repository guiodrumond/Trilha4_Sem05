public class Exercicio07 {
    public static void main(String[] args) {
        ...
        String nomeCliente2 = "Marcela";
        String nomeCliente3 = "Maria";
        String nomeCliente4 = "Adalberto";

        int anoNascimentoCliente1 = 2007;
        int anoNascimentoCliente2 = 1978;
        int anoNascimentoCliente3 = 1954;
        int anoNascimentoCliente4 = 2001;
        ...
        /*
         Eu fiz o código assim pois acho que só posso usar o que estamos aprendendo agora.
         Com certeza há formas mais eficientes de fazer essa implementação...
        */

        if (idade1 < 18) faixaEtaria1 = "ADOLESCENTE";
        else if ((idade1 < 30)) faixaEtaria1 = "JOVEM";
        else if ((idade1 < 60)) faixaEtaria1 = "ADULTO";
        else faixaEtaria1 = "IDOSO";

        if (idade2 < 18) faixaEtaria2 = "ADOLESCENTE";
        else if ((idade2 < 30)) faixaEtaria2 = "JOVEM";
        else if ((idade2 < 60)) faixaEtaria2 = "ADULTO";
        else faixaEtaria2 = "IDOSO";

        if (idade3 < 18) faixaEtaria3 = "ADOLESCENTE";
        else if ((idade3 < 30)) faixaEtaria3 = "JOVEM";
        else if ((idade3 < 60)) faixaEtaria3 = "ADULTO";
        else faixaEtaria3 = "IDOSO";

        if (idade4 < 18) faixaEtaria4 = "ADOLESCENTE";
        else if ((idade4 < 30)) faixaEtaria4 = "JOVEM";
        else if ((idade4 < 60)) faixaEtaria4 = "ADULTO";
